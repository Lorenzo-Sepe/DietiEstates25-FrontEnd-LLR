...
export default {
  test(id) {
    return Api()
      .get("/pb/test/getToken", { params: { id } })
  ...
  getAnnunciDiTest() {
    const annuncio = {
      ...
      descrizione:
        "QUesto è stato modificato per la terza volta (controllo cambio contratto)",
      agente: {
      ...
      immobile: {
        ...
        immagini: [
          ...
          },
          {
            ...
            descrizione:
              "questo la seconda immagine ora è un appartamento non piu il logo dell'uni",
          },
        ],
      },
      contratto: {
