...
const resolver = ({ values }) => {
  ...
  if (
    !values.nomeAgenzia ||
    values.nomeAgenzia.length < 3 ||
    values.nomeAgenzia.length > 100
  ) {
    errors.nomeAgenzia = [
      { message: "Il nome dell'agenzia deve avere tra 3 e 100 caratteri." },
    ];
  }
  if (
    !values.nomeFondatore ||
    values.nomeFondatore.length < 3 ||
    values.nomeFondatore.length > 100
  ) {
    errors.nomeFondatore = [
      { message: "Il nome del fondatore deve avere tra 3 e 100 caratteri." },
    ];
  }
  ...
  if (
    !values.cognomeFondatore ||
    values.cognomeFondatore.length < 3 ||
    values.cognomeFondatore.length > 100
  ) {
    errors.cognomeFondatore = [
      { message: "Il cognome del fondatore deve avere tra 3 e 100 caratteri." },
    ];
  }
  ...
  if (
    ...
    values.ragioneSociale.length < 3 ||
    values.ragioneSociale.length > 80
  ) {
    errors.ragioneSociale = [
      { message: "La ragione sociale deve avere tra 3 e 80 caratteri." },
    ];
  }
  ...
  if (!values.partitaIva || !partitaIvaPattern.test(values.partitaIva)) {
    errors.partitaIva = [
      {
        message:
          "La partita IVA deve essere un numero di esattamente 11 cifre.",
      },
    ];
  }
  ...
  if (
    !values.dominio ||
    !dominioPattern.test(values.dominio) ||
    values.dominio.includes(" ")
  ) {
    errors.dominio = [
      {
        message:
          "Il dominio deve contenere solo lettere e numeri, senza caratteri speciali o spazi.",
      },
    ];
  }
