<template>
  <div class="flex flex-col w-full h-full">
    <ScheletroTabella v-if="props.propLoading" class="w-full"/>
      ...
      >
        <template #header>
          <div class="flex flex-wrap justify-end gap-2">
            <Button
              v-if="props.isAgente"
              label="Aggiungi annuncio immobilare"
            />
          </div>
        </template>
        ...
        <Column header="Copertina">
          <template #body="slotProps">
            <img
              :src="`${slotProps.data.immobile.immagini[0].url}`"
              :alt="'..'"
              class="shadow-lg"
              width="64"
            />
          ...
          <template #body>
            <div class="flex flex-row gap-2">
              ...
              >
                <template #icon>
                  <img
                    alt="Modifica annuncio"
                    src="../../assets/Icon/modificaAnnuncio.png"
                    class="w-5 h-5"
                  />
                </template>
              </Button>
              ...
              >
                <template #icon>
                  <img
                    alt="Elimina annuncio"
                    src="../../assets/Icon/eliminaAnnuncio.png"
                    class="w-5 h-5"
                  />
                </template>
              </Button>
        ...
        <template #expansion="slotProps" class="proposte-in-trattativa">
          <div class="bg-gray-200">
            <div
              class="intestazione-proposte flex items-center justify-center p-4 gap-16"
            >
            ...
            <div class="card flex justify-center">
              <Dialog
                v-model:visible="dialogControproposta"
                :style="{ width: 'auto' }"
                header="Form controproposta"
                :modal="true"
              >
                <FormControproposta
                  :proposta="propostaSelected"
            ...
            <div class="p-4">
              ...
              >
                <Column
                  field="datiProponente.nome"
                  header="Nome"
                  sortable
                ></Column>
                <Column
                  field="datiProponente.cognome"
                  header="Cognome"
                  sortable
                ></Column>
                <Column
                  field="datiProponente.email"
                  header="Email"
                  sortable
                ></Column>
                <Column field="prezzoProposta" header="Proposta" sortable>
                  <template #body="slotProps">
                    <span
                      :class="{
                        'line-through': slotProps.data.controproposta !== null,
                      }"
                    >
                ...
                <Column
                  field="controproposta"
                  header="Controproposta"
                  sortable
                ></Column>
                <Column headerStyle="width:4rem">
                  <template #body="slotProps">
                    <div class="flex flex-row gap-2">
                      ...
                      >
                        <template #icon>
                          <img
                            src="../../assets/Icon/accettaProposta.png"
                            class="w-5 h-5"
                          />
                        </template>
                      </Button>
                      ...
                      >
                        <template #icon>
                          <img
                            src="../../assets/Icon/controproposta.png"
                            class="w-5 h-5"
                          />
                        </template>
                      </Button>
                      ...
                      >
                        <template #icon>
                          <img
                            src="../../assets/Icon/rifiutaProposta.png"
                            class="w-5 h-5"
                          />
                        </template>
                      </Button>
