...
const errori = reactive({
  ...
  tipologia: {
    invalid: false,
    messaggio: "Seleziona una tipologia di immobile",
  },
});
  ...
  if (campo === "titolo") {
    ...
    if (titolo.length === 0) {
      ...
      errori.titolo.messaggio =
        "Il titolo deve essere di massimo 100 caratteri";
    } else {
...
const validaCampi = () => {
  ["titolo", "descrizione", "contratto", "tipologia"].forEach((campo) =>
    verificaDati(campo),
  );
  ...
  <div class="">
    ...
    <div class="flex flex-col gap-4">
      <div class="flex flex-col">
        ...
        />
        <Message
          v-if="errori.titolo.invalid"
          severity="error"
          variant="simple"
          size="small"
          >{{ errori.titolo.messaggio }}</Message
        >
      </div>
      ...
      <div class="flex flex-col">
        ...
        />
        <Message
          v-if="errori.descrizione.invalid"
          severity="error"
          variant="simple"
          size="small"
      ...
      <div class="flex flex-col">
        <label for="tipoContratto" class="font-semibold"
      ...
      <div class="flex flex-col">
        <label for="tipologiaImmobile" class="font-semibold"
          >Tipologia di Immobile</label
        >
        <Select
