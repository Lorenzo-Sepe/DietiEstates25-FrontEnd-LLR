<template>
    ...
    <div class="w-full h-full flex felx-col gap-2 p-2 md:flex-row bg-gray-100"
        v-if="isAnnuncioCompleto(props.annuncio)">

        <div class="area-annuncio w-full md:w-[90%] lg:w-[55%] flex flex-col gap-2 mx-auto">

            <div class="intestazione-schemi-piccoli w-full flex flex-row gap-2 p-2 block lg:hidden">
                ...
                <Dialog v-model:visible="mostraDialogProposte" maximizable modal header="PROPOSTE" :style="{ width: '90%' }"
            ...
            <div class="info-principali w-full flex flex-col p-2 items-start bg-white gap-2">
                ...
                <span class="titolo text-2xl md:text-4xl font-bold text-left">{{ props.annuncio.titolo }}</span>

                <span class="indirizzo text-sm md:text-lg text-left text-blue-600 font-medium">{{
                ...
                <span v-if="props.annuncio.contratto.tipoContratto == 'AFFITTO'"
                    ...
                    {{ formattaPrezzo(props.annuncio.contratto.contrattoAffittoResponse.prezzoAffitto) }} € /mese
                </span>
                ...
                <div class="caratteristiche-principali flex flex-row gap-2">
                    <span class="mq text-sm text-left md:text-2xl md:font-medium">{{ props.annuncio.immobile.metriQuadri
                    }} m2</span>
                    <div class="h-8 border-1"></div>
                    <span class="numero-piani text-sm text-left md:text-2xl md:font-medium">{{
                        props.annuncio.immobile.numeroDiPiani }} piani</span>
                    <div class="h-8 border-1"></div>
                    <span class="numero-bagni text-sm text-left md:text-2xl md:font-medium">{{
                        props.annuncio.immobile.numeroServizi }} bagni</span>
                    <div class="h-8 border-1"></div>
                    <span class="numero-stanze text-sm text-left md:text-2xl md:font-medium">{{
                        props.annuncio.immobile.numeroStanze }} stanze</span>
                </div>

            </div>

            <div class="accordions-informazioni-secondarie w-full flex flex-col p-2 items-start bg-white">
                    ...
                    <AccordionPanel value="1" class="caratteristiche mt-2">
                        ...
                        <AccordionContent>
                            <div class="flex flex-col gap-2">
                                <span v-if="props.annuncio.immobile.caratteristicheAggiuntive.ascensore">Nel palazzo è
                                    presente l'ascensore</span>
                                <span v-if="props.annuncio.immobile.caratteristicheAggiuntive.balconi">Sono presenti uno
                                    o più balconi</span>
                                <span v-if="props.annuncio.immobile.caratteristicheAggiuntive.cantina">L'immobile
                                    dispone di una cantina</span>
                                <span v-if="props.annuncio.immobile.caratteristicheAggiuntive.soffitta">L'immobile
                                    dispone di una soffitta</span>
                                <span v-if="props.annuncio.immobile.caratteristicheAggiuntive.climatizzatori">Sono
                                    presenti uno o più condizionatori</span>
                                <span v-if="props.annuncio.immobile.caratteristicheAggiuntive.garage">È compreso il
                                    garage</span>
                                <span v-if="props.annuncio.immobile.caratteristicheAggiuntive.postiAuto">È compreso il
                                    posto auto</span>
                                <span v-if="props.annuncio.immobile.caratteristicheAggiuntive.giardino">L'immobile
                                    dispone di un giardino</span>
                                <span v-if="props.annuncio.immobile.caratteristicheAggiuntive.pannelliSolari">Impianto
                                    fotovoltaico installato per la produzione di energia elettrica autonoma</span>
                                <span v-if="props.annuncio.immobile.caratteristicheAggiuntive.portiere">Servizio di
                                    portineria presente</span>
                            ...
                            <div v-if="props.annuncio.contratto.tipoContratto === 'AFFITTO'"
                                ...
                                <span class="text-lg">
                                    ...
                                    <span class="font-medium">{{
                                        props.annuncio.contratto.contrattoAffittoResponse.tempoMinimo }} mesi</span>
                                </span>
                                <span class="text-lg">
                                    Tempo massimo di affitto:
                                    <span class="font-medium">{{
                                        props.annuncio.contratto.contrattoAffittoResponse.tempoMassimo }} mesi</span>
                                </span>

                                <span class="mt-4 text-lg">
                                    Prezzo affitto:
                                    <span class="font-medium">{{
                                        formattaPrezzo(props.annuncio.contratto.contrattoAffittoResponse.prezzoAffitto)
                                        }}
                                        €</span>
                                </span>
                                <span class="text-lg">
                                    Cauzione:
                                    <span class="font-medium">{{
                                        formattaPrezzo(props.annuncio.contratto.contrattoAffittoResponse.caparra)
                                        }} €</span>
                                </span>


                            </div>
                            <div v-else class="informazioni-vendita w-full flex flex-col gap-2">
                                <span class="mt-4 text-lg">
                                    Prezzo Vendita:
                                    <span class="font-medium">{{
                                        formattaPrezzo(props.annuncio.contratto.contrattoVenditaResponse.prezzoVendita)
        ...
        <div class="flex flex-col gap-2 w-[45%] hidden lg:block">
            ...
            <div class="area-contatti-agente w-full flex flex-col gap-2 p-2 items-center justify-center">
                <CardContattiAgente />
            </div>
