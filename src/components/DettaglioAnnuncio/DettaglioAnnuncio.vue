<template>
  ...
  <div class="w-full h-full flex felx-col gap-2 p-2 md:flex-row bg-gray-100" v-if="isAnnuncioCompleto(props.annuncio)">
    <div class="area-annuncio w-full md:w-[90%] lg:w-[55%] flex flex-col gap-2 mx-auto">
      <div class="intestazione-schemi-piccoli w-full flex flex-row gap-2 p-2 lg:hidden">
        ...
        <Dialog v-model:visible="mostraDialogCardAgente" modal header="Contatti agente" :style="{ width: '100%' }"
          :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
          <CardContattiAgente :agente="props.annuncio.agente" />
        </Dialog>
      ...
      <div class="info-principali w-full flex flex-col p-2 items-start bg-white gap-2">
        ...
        <span class="indirizzo text-sm md:text-lg text-left text-blue-600 font-medium cursor-pointer hover:underline"
          @click="vissualizzaPosizioneAnnuncioSuMappa()">{{
        ...
        <Accordion value="0" class="accordiations w-full">
          ...
          <AccordionPanel value="2" class="contratto mt-2">
            ...
            <AccordionContent>
              ...
              <div v-else>
                <span>Nessuna informazione contrattuale disponibile.</span>
              </div>
            </AccordionContent>
          </AccordionPanel>
        </Accordion>
    ...
    <div class="flex flex-col gap-2 w-[45%] hidden lg:block">
      ...
      <div class="area-proposte w-full flex flex-col gap-2 p-2 mx-auto">
        <TabellaProposte :proposte="props.annuncio.proposte" :contratto="props.annuncio.contratto"
          :propostaRequest="props.propostaRequest" @inviaNuovaProposta="inviaNuovaProposta" />
      </div>
    </div>
  </div>
...
const vissualizzaPosizioneAnnuncioSuMappa = () => {
  coordinata.value.latitudine = props.annuncio.immobile.indirizzo.latitudine;
  coordinata.value.longitudine = props.annuncio.immobile.indirizzo.longitudine;
