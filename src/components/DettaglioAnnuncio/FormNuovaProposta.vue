<template>
  ...
  >
    <div class="w-full flex flex-col gap4">
      <label class="medium text-lg mb-2">
        Confermi di voler inviare la proposta?
      </label>
  ...
  <div class="form-nuova-proposta">
    <div class="flex flex-col gap-4">
      <div class="flex flex-col gap-2 my-2">
        ...
        <div class="flex flex-col my-2">
          ...
          <InputText
            id="contatto"
            v-model="cognome"
            :invalid="errori.cognome.invalido"
          />
        </div>
        <div class="flex flex-col my-2">
          ...
          <Select
            ...
            :invalid="errori.tipoContatto.invalido"
        ...
        <div class="flex flex-col my-2">
          ...
          <InputText
            id="contatto"
            v-model="contatto"
            :invalid="errori.contatto.invalido"
          />
          <Message severity="error" variant="simple" size="small">{{
      ...
      <div class="flex flex-col gap-1">
        ...
        <InputNumber
          v-model="proposta"
          :invalid="errori.prezzo.invalido"
...
const clickEffettuaProposta = () => {
  ...
  if (
    !errori.prezzo.invalido &&
    !errori.tipoContatto.invalido &&
    !errori.contatto.invalido &&
    !errori.nome.invalido &&
    !errori.cognome.invalido
  ) {
    errori.prezzo.invalido = false;
    errori.prezzo.messaggio = "";
    errori.tipoContatto.invalido = false;
