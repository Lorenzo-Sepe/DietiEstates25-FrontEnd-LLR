...
const editor = useEditor({
  editorProps: {
    attributes: {
      class:
        "tiptap-editor bg-surface-100 overflow-auto rounded-b p-2 min-h-[20rem] max-h-[12rem] overflow-y-auto outline-none",
    },
  },
  ...
  extensions: [
    ...
    Image.configure({
      HTMLAttributes: {
        class: "tiptap-image",
        style:
          "max-width: 100%; height: auto; object-fit: contain; display: block; margin: 0 auto;", // Stile responsive
      },
    }),
    Underline,
    FontSize,
