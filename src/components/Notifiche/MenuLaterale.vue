<template>
    ...
    <template #container="{ closeCallback }">
      <div class="flex flex-col p-4">
        ...
        <ImpostazioniSottoscrizioni
          ...
          :dialogSottoscrizioni="impostazioniSottoscrizineVisibe"
  ...
  <div class="card my-4">
    <Accordion
      v-model:activeIndex="accordionChiuso"
      @update:activeIndex="onAccordionChange"
    >
      <AccordionPanel>
        <AccordionHeader>{{ getTitle() }}</AccordionHeader>
        <AccordionContent class="text-left items-start">
          <CategoriaMenuLaterale
            v-for="categoria in filteredCategorieAttive"
            :categoria="categoria"
          ...
          <div class="flex flex-col items-start my-4">
            ...
            <CategoriaMenuLaterale
              v-for="categoria in filteredCategorieDisattivate"
              :categoria="categoria"
              @modificaSottoscrizione="modificaSottoscrizione"
            />
          </div>
