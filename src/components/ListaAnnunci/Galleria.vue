<template>
    <div class="contenitore-foto w-full h-full relative">
        <!-- Immagine -->
        <img :src="props.immagini[currentImageIndex].url" alt="Immagine" class="w-full h-full rounded-lg">
        ...
        <button
            ...
            @click="prevImage">
            <img src="../../assets/Icon/left-arrow.png" alt="Freccia" class="w-5 h-5 inline" />
        </button>
        ...
        <button
            ...
            @click="nextImage">
            <img src="../../assets/Icon/right-arrow.png" alt="Freccia" class="w-5 h-5 inline" />
        </button>
    </div>
</template>
