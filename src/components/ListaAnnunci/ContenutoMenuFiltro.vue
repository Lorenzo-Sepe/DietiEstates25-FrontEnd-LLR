    ...
    <div class="flex flex-col gap-8 w-full md:h-100 overflow-y-auto items-start justify-start p-2 bg-white">
        ...
        <div class="luogo w-full">
            ...
            <div class="Comune-nella-mappa flex flex-col items-start justify-start mb-2">
                ...
                <AutoComplete :fluid="true" v-model="luogoCercato" optionLabel="comune" :suggestions="filteredCountries"
                    placeholder="Scrivi dove cerchi l'immobile" @complete="search" />
            </div>
...
const luogoCercato = ref({ comune: route.query.comune, latitudine: route.query.lat, longitudine: route.query.lon });
...
const onApliccaFiltro = () => {
    ...
    router.push({
        ...
        query: {
            ...
            balconi: caratteristicheAggiuntive.value.balconi ? caratteristicheAggiuntive.value.balconi : null,
            garage: caratteristicheAggiuntive.value.garage ? caratteristicheAggiuntive.value.garage : null,
            postiAuto: caratteristicheAggiuntive.value.postiAuto ? caratteristicheAggiuntive.value.postiAuto : null,
            giardino: caratteristicheAggiuntive.value.giardino ? caratteristicheAggiuntive.value.giardino : null,
            ascensore: caratteristicheAggiuntive.value.ascensore ? caratteristicheAggiuntive.value.ascensore : null,
            portiere: caratteristicheAggiuntive.value.portiere ? caratteristicheAggiuntive.value.portiere : null,
            riscaldamentoCentralizzato: caratteristicheAggiuntive.value.riscaldamentoCentralizzato ? caratteristicheAggiuntive.value.riscaldamentoCentralizzato : null,
            climatizzatore: caratteristicheAggiuntive.value.climatizzatori ? caratteristicheAggiuntive.value.climatizzatori : null,
            pannelliSolari: caratteristicheAggiuntive.value.pannelliSolari ? caratteristicheAggiuntive.value.pannelliSolari : null,
            cantina: caratteristicheAggiuntive.value.cantina ? caratteristicheAggiuntive.value.cantina : null,
            soffitta: caratteristicheAggiuntive.value.soffitta ? caratteristicheAggiuntive.value.soffitta : null,
...
watch(route, (newRoute) => {
    ...
    caratteristicheAggiuntive.value.postiAuto = route.query.postiAuto ? true : false;  
    caratteristicheAggiuntive.value.giardino = route.query.giardino ? true : false;
    caratteristicheAggiuntive.value.ascensore = route.query.ascensore ? true : false;
    caratteristicheAggiuntive.value.portiere = route.query.portiere ? true : false;
    caratteristicheAggiuntive.value.riscaldamentoCentralizzato = route.query.riscaldamentoCentralizzato ? true : false;
    caratteristicheAggiuntive.value.climatizzatori = route.query.climatizzatore ? true : false;
    caratteristicheAggiuntive.value.pannelliSolari = route.query.pannelliSolari ? true : false;
    caratteristicheAggiuntive.value.cantina = route.query.cantina ? true : false;
    caratteristicheAggiuntive.value.soffitta = route.query.soffitta ? true : false;
});
