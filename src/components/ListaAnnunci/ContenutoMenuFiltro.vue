...
const onApliccaFiltro = () => {
    ...
    router.push({
        ...
        query: {
            ...
            riscaldamentoCentralizzato: isCaratteristicaSelezionata("Riscaldamento centralizzato") ? true : null,
            climatizzatore: isCaratteristicaSelezionata("Climatizzatori") ? true : null,
            pannelliSolari: isCaratteristicaSelezionata("Pannelli solari") ? true : null,
